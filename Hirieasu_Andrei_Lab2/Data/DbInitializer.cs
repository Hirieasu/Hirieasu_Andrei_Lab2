        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
           ...
           LibraryContext(serviceProvider.GetRequiredService
            <DbContextOptions<LibraryContext>>()))
            {
                ...
                {
                    new Models.Order{BookID=4,CustomerID=1,OrderDate=DateTime.Parse("2021-02-25")},
                    new Models.Order{BookID=6,CustomerID=2,OrderDate=DateTime.Parse("2021-09-28")},
                    new Models.Order{BookID=8,CustomerID=3,OrderDate=DateTime.Parse("2021-10-28")},
                    new Models.Order{BookID=7,CustomerID=1,OrderDate=DateTime.Parse("2021-09-28")},
                    new Models.Order{BookID=4,CustomerID=2,OrderDate=DateTime.Parse("2021-09-28")},
                    new Models.Order{BookID=8,CustomerID=3,OrderDate=DateTime.Parse("2021-10-28")},
                };
